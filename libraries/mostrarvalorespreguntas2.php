...
$result2=mysqli_query($link,"SELECT IdRespuesta, Respuesta, Argumento, Tipo FROM respuestas WHERE IdPregunta= $id"); 
   ...
   $result5=mysqli_query($link,"SELECT IdRespuesta, Respuesta, Argumento, Tipo FROM respuestas WHERE IdPregunta= $id && IdRespuesta != $id1 && IdRespuesta != $id2 && IdRespuesta != $id3"); 
   $row5 = $result5 ->fetch_assoc();
 $id4=$row5['IdRespuesta'];
//echo $row['BaseReac'];
